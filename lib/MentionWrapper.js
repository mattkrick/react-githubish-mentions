...
var _MentionPortal = require("./MentionPortal");

var _MentionPortal2 = _interopRequireDefault(_MentionPortal);

var _MentionScrollBar = require("./MentionScrollBar");

var _MentionScrollBar2 = _interopRequireDefault(_MentionScrollBar);
  ...
  _createClass(MentionWrapper, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          isNotBrowser = _props.isNotBrowser,
          portal = _props.portal,
          containerStyle = _props.style,
          inputProps = _objectWithoutProperties(_props, ["children", "component", "getRef", "isNotBrowser", "portal", "style"]);
      ...
      var textAreaClassName = isNotBrowser ? 'p1 width-100-percent flex-auto height-100-percent' : 'p1 width-100-percent flex-auto height-100-percent mb2';
      return _react2.default.createElement(
        "div",
        { style: isNotBrowser ? _extends({}, containerStyle, {
            display: 'flex',
        ...
        isNotBrowser ? top !== undefined && _react2.default.createElement(_MentionScrollBar2.default, {
          active: active,
          className: className,
          ...
          style: style,
          top: top
        }) : top !== undefined && _react2.default.createElement(
          Portal,
          { closeFunc: this.closeMenu },
          _react2.default.createElement(_MentionMenu2.default, {
            active: active,
            className: className,
            left: left,
            isOpen: options.length > 0,
...
MentionWrapper.propTypes = {
  isNotBrowser: _propTypes2.default.bool.isRequired,
  portal: _propTypes2.default.func.isRequired,
  position: _propTypes2.default.oneOf(["start", "caret"])
};

MentionWrapper.defaultProps = {
  isNotBrowser: false,
  portal: _MentionPortal2.default,
  position: "caret"
};
